...
public class PlayerListNew extends Activity implements ListView.OnScrollListener{
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				...
				if (player.steamdId64 == 0){
					...
					new HttpConnection(handler)
						.getSpecificLines("http://steamcommunity.com/id/" + player.communityId + "/?xml=1", 2, -1);
				} else {
					if (setPlayerId) {
						Intent result = new Intent();
